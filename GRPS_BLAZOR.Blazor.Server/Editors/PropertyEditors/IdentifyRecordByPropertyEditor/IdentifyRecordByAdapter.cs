...
{
    public class IdentifyRecordByAdapter : ComponentAdapterBase
    {
        public IdentifyRecordByAdapter(IdentifyRecordByModel componentModel)
        {
            ComponentModel = componentModel ?? throw new ArgumentNullException(nameof(componentModel));
            ComponentModel.ValueChanged += ComponentModel_ValueChanged;
        }
        public override IdentifyRecordByModel ComponentModel { get; }
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, IdentifyRecordByRenderer.Create(ComponentModel));
        }
