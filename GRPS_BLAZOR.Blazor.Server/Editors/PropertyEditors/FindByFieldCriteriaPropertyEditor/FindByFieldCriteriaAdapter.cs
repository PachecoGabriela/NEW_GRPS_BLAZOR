...
{
    public class FindByFieldCriteriaAdapter : ComponentAdapterBase
    {
        public FindByFieldCriteriaAdapter(FindByFieldCriteriaModel componentModel)
        {
            ComponentModel = componentModel ?? throw new ArgumentNullException(nameof(componentModel));
            ComponentModel.ValueChanged += ComponentModel_ValueChanged;
        }
        public override FindByFieldCriteriaModel ComponentModel { get; }
        ...
        {
            return ComponentModelObserver.Create(ComponentModel, FindByFieldCriteriaRenderer.Create(ComponentModel));
        }
