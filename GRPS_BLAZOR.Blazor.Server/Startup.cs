...
using GRPS_BLAZOR.Blazor.Server.Mappings;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<GRPS_BLAZORBlazorApplication>();
            builder.Modules
                ...
                .Add<GRPS_BLAZOR.Module.GRPS_BLAZORModule>()
                .Add<GRPS_BLAZORBlazorModule>()
                .Add<ExcelImport.Blazor.BlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(GRPS_BLAZOR.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(GRPS_BLAZOR.Module.BusinessObjects.ApplicationUserLoginInfo);
